...
module.exports = function(app) {
    ...
    app.post('/outbound', function(request, response) {
        var salesNumber = '+18556555653 ';//Linkedin's sales Group number //request.params.salesNumber;
        var twimlResponse = new VoiceResponse();

        twimlResponse.say('Thanks for contacting our support department. Our ' +
